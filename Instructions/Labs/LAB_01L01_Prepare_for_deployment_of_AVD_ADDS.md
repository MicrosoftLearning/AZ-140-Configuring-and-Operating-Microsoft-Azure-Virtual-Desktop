...
1. On the **Azure AD Connect** blade, first select the **Connect Sync** link at the left and then select the **Download Azure AD Connect** link. This will automatically open a new browser tab displaying the **Microsoft Azure Active Directory Connect** download page.
