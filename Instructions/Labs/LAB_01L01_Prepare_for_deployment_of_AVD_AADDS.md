...
>**Note**: Provisioning of an Microsoft Entra DS involves about 90-minute wait time.

## Lab scenario

You need to prepare for deployment of Azure Virtual Desktop in a Microsoft Entra Domain Services (Microsoft Entra DS) environment
...
1. Create and configure Microsoft Entra user account for administration of Azure AD DS domain
