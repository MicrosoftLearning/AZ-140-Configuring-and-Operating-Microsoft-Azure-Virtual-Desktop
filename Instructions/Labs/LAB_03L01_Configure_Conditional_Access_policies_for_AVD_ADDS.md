...
1. On the **New** blade, configure the following settings:
   ...
   - In the **Assignments** section, select the **Users or workload identities** option, Under **What does this policy apply to?** drop-down make sure **Users and groups** is selected and click the **Users and groups** checkbox under the **Select Users and groups**, on the **Select** blade, click **aduser5**, and click **Select**.
